	...
	<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> ELECTRONICS [230]</a>
				<ul>
				<li><a class="active" href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Cameras (100) </a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Computers, Tablets & laptop (30)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Mobile Phone (80)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Sound & Vision (15)</a></li>
				</ul>
			</li>
			<li class="subMenu"><a> CLOTHES [840] </a>
			<ul style="display:none">
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Women's Clothing (45)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Women's Shoes (8)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Women's Hand Bags (5)</a></li>	
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Men's Clothings  (45)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Men's Shoes (6)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Kids Clothing (5)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Kids Shoes (3)</a></li>												
			</ul>
			</li>
			<li class="subMenu"><a>FOOD AND BEVERAGES [1000]</a>
				<ul style="display:none">
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Angoves  (35)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Bouchard Aine & Fils (8)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>French Rabbit (5)</a></li>	
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Louis Bernard  (45)</a></li>
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>BIB Wine (Bag in Box) (8)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Other Liquors & Wine (5)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Garden (3)</a></li>												
				<li><a href="<c:url value="resources/products.html"/>"><i class="icon-chevron-right"></i>Khao Shong (11)</a></li>												
			</ul>
			</li>
			<li><a href="<c:url value="resources/products.html"/>">HEALTH & BEAUTY [18]</a></li>
			<li><a href="<c:url value="resources/products.html"/>">SPORTS & LEISURE [58]</a></li>
			<li><a href="<c:url value="resources/products.html"/>">BOOKS & ENTERTAINMENTS [14]</a></li>
		</ul>
		<br/>
		  <div class="thumbnail">
			...
			<div class="caption">
			  <h5>Panasonic</h5>
				<h4 style="text-align:center"><a class="btn" href="<c:url value="resources/product_details.html"/>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
			</div>
		  </div><br/>
			<div class="thumbnail">
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
		<li><a href="<c:url value="resources/index.html"/>">Home</a> <span class="divider">/</span></li>
...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		<div class="row">
			<div class="span3">
				<h5>ACCOUNT</h5>
				<a href="<c:url value="resources/login.jsp"/>">YOUR ACCOUNT</a>
				<a href="<c:url value="resources/login.jsp"/>">PERSONAL INFORMATION</a> 
				<a href="<c:url value="resources/login.jsp"/>">ADDRESSES</a> 
				<a href="<c:url value="resources/login.jsp"/>">DISCOUNT</a>  
				<a href="<c:url value="resources/login.jsp"/>">ORDER HISTORY</a>
			 </div>
			<div class="span3">
				<h5>INFORMATION</h5>
				<a href="<c:url value="resources/contact.jsp"/>">CONTACT</a>  
				<a href="<c:url value="resources/register.jsp"/>">REGISTRATION</a>  
				<a href="<c:url value="resources/legal_notice.jsp"/>">LEGAL NOTICE</a>  
				<a href="<c:url value="resources/tac.jsp"/>">TERMS AND CONDITIONS</a> 
				<a href="<c:url value="resources/faq.jsp"/>">FAQ</a>
			 </div>
			<div class="span3">
				<h5>OUR OFFERS</h5>
			...
			<div id="socialMedia" class="span3 pull-right">
				<h5>SOCIAL MEDIA </h5>
				<a href="#"><img width="60" height="60" src="<c:url value="resources/themes/images/facebook.png"/>" title="facebook" alt="facebook"/></a>
				<a href="#"><img width="60" height="60" src="<c:url value="resources/themes/images/twitter.png"/>" title="twitter" alt="twitter"/></a>
				<a href="#"><img width="60" height="60" src="<c:url value="resources/themes/images/youtube.png"/>" title="youtube" alt="youtube"/></a>
			 </div> 
		 </div>
...
<script src="themes/switch/theamswitcher.js" type="text/javascript" charset="utf-8"></script>
	...
	<a href="<c:url value="resources/themes/css/#"/>" name="businessltd"><img src="<c:url value="resources/themes/switch/images/clr/businessltd.png"/>" alt="bootstrap business templates" class="active"></a>
	</div>
